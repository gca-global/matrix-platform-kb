...
> **Repository:** [github.com/gca-ltd/matrix-platform-kb](https://github.com/gca-ltd/matrix-platform-kb)
...
```
Base URL: https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/
```
...
|-------|----------|---------------|
| Full architecture | `docs/architecture/overview.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/architecture/overview.md) |
| Platform overview | `docs/platform/index.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/index.md) |
| Ecosystem architecture | `docs/platform/ecosystem-architecture.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/ecosystem-architecture.md) |
| App catalog (all apps & status) | `docs/platform/app-catalog.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/app-catalog.md) |
...
| Topic | Document | GitHub Raw URL |
|-------|----------|---------------|
| Security model (full) | `docs/platform/security-model.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/security-model.md) |
| App template (auth flow) | `docs/platform/app-template.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/app-template.md) |
| GDPR & compliance | `docs/platform/compliance.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/compliance.md) |
...
| Topic | Document | GitHub Raw URL |
|-------|----------|---------------|
| API contracts | `docs/platform/api-contracts.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/api-contracts.md) |
| App template (Edge Functions) | `docs/platform/app-template.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/app-template.md) |
| Operations & deployment | `docs/platform/operations.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/operations.md) |
...
| Topic | Document | GitHub Raw URL |
|-------|----------|---------------|
| CDL schema (cross-app data layer — listings + control plane + EFs) | `docs/data-models/cdl-schema.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/data-models/cdl-schema.md) |
| Dash data model | `docs/data-models/dash-data-model.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/data-models/dash-data-model.md) |
| Platform extensions (x_*) | `docs/data-models/platform-extensions.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/data-models/platform-extensions.md) |
| RESO canonical schema | `docs/data-models/reso-dd-kb/wiki/dbml/canonical.dbml` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/data-models/reso-dd-kb/wiki/dbml/canonical.dbml) |
| Field mapping (Dash ↔ RESO ↔ Qobrix) | `docs/data-models/property-field-mapping.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/data-models/property-field-mapping.md) |
| Data quality | `docs/data-models/data-quality.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/data-models/data-quality.md) |
...
| Topic | Document | GitHub Raw URL |
|-------|----------|---------------|
| ETL pipeline architecture | `docs/data-models/etl-pipeline.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/data-models/etl-pipeline.md) |
| MLS datamart & migration | `docs/platform/mls-datamart.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/mls-datamart.md) |
| Data contracts | `docs/data-models/data-contracts.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/data-models/data-contracts.md) |
| RESO Web API | `docs/data-models/reso-web-api.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/data-models/reso-web-api.md) |
...
| Topic | Document | GitHub Raw URL |
|-------|----------|---------------|
| App template (full stack details) | `docs/platform/app-template.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/app-template.md) |
| Testing strategy | `docs/platform/testing-strategy.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/testing-strategy.md) |
| Performance targets | `docs/platform/performance.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/performance.md) |
| Mobile strategy | `docs/platform/mobile-strategy.md` | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/platform/mobile-strategy.md) |
...
|---------|---------|-----------|
| **Canonical RESO processes** (Listing / Showing / OpenHouse / Lead-Contact / Transaction / Member / Office / Team / Caravan / Media lifecycles) | Vendor-neutral RESO state machines | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/business-processes/canonical-processes/USAGE.md) |
| **Matrix Pipeline 2.0 (CRM)** | Sharp-SIR luxury sales CRM product spec — entities, FRs, AI, phases | [View](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/product-specs/matrix-pipeline/INDEX.md) |
...
| Resource | URL |
|----------|-----|
| Knowledge Base (GitHub) | [github.com/gca-ltd/matrix-platform-kb](https://github.com/gca-ltd/matrix-platform-kb) |
...
| Full KB Index | [docs/index.md](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/docs/index.md) |
| AGENTS.md (entry point) | [AGENTS.md](https://raw.githubusercontent.com/gca-ltd/matrix-platform-kb/main/AGENTS.md) |
