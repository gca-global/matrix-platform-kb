...
| [matrix-stardom.md](matrix-stardom.md) | **Matrix Stardom** — shared HumaticAI prompt workspace: prompt library + curation, scheduled prompt automations (`prompt-scheduler` EF + hourly `pg_cron`), and engagement-driven "Most popular" ranking |
